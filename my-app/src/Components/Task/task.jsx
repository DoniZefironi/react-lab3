...
function CompanyGoal() {
  ...
  return (
    <section style={{ padding: '20px', textAlign: 'center',}}>
      <h2>Наша цель</h2>
      <p>
        Мы стремимся к тому, чтобы наши клиенты были полностью удовлетворены качеством наших блюд.
        Наша цель — достичь 100% удовлетворенности клиентов, предлагая лучшие блюда и напитки.
      </p>
